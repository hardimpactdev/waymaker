---
name: release
description: Publish a new release of hardimpactdev/waymaker to Packagist. Handles CHANGELOG updates, git tagging via GitHub CLI, and creating GitHub releases.
allowed-tools: Read, Write, Edit, Bash, Glob, Grep
---

# Release Workflow for hardimpactdev/waymaker
...
**Full Changelog**: https://github.com/hardimpactdev/waymaker/compare/v0.1.0...v$VERSION
EOF
```
...
3. **Composer Update**: Users can now `composer update hardimpactdev/waymaker`
...
CURRENT_SHA=$(gh api repos/hardimpactdev/waymaker/git/refs/heads/main --jq '.object.sha')

# Create a blob for each changed file
BLOB_SHA=$(gh api repos/hardimpactdev/waymaker/git/blobs \

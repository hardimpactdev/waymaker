...
test('it correctly generates URIs for different scenarios', function () {
    ...
    $testCases = [
        ...
        [null, 'custom/uri', null, 'UserController', 'index', '/user/custom/uri'],
        [null, '/custom/uri', null, 'UserController', 'index', '/custom/uri'],
        [null, '/settings/security', null, 'SecurityController', 'edit', '/settings/security'],
        ['admin', 'custom/uri', null, 'UserController', 'index', '/admin/custom/uri'],
